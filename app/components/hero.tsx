    ...
    <div className="flex justify-center relative my-20 z-10">
        <div className='max-w-[89vw] md:max-w-2xl lg:max-w-[60vw] flex flex-col items-center justify-center'>
            ...
            <TextGenerateEffect
                ...
                words="Welcome to Rayhan's Portfolio"
                />
            <p className="text-center md:tracking-wider mb-4 text-sm md:text-lg lg-text-2xl text-white">
                Hi, I&apos;m Rayhan, a Front End Developer based in Indonesia.
            </p>
            <a href="https://drive.google.com/file/d/1ZkyVkzVnulwdLeTU2hzmGhoKWL3hyT1a/view?usp=sharing" target="_blank" rel="noopener noreferrer">
                <MagicButton
